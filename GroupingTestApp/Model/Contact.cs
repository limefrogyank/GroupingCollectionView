...
namespace GroupingTestApp.Model
{
    public class Contact
    {
        ...
        public static IEnumerable<IGrouping<object,object>> GetContactsIGrouped(int numberOfContacts)
        {
            //ObservableCollection<GroupInfoList> groups = new ObservableCollection<GroupInfoList>();
            var contacts = GetContacts(numberOfContacts);
            var groups = contacts.GroupBy(x => x.LastName);
